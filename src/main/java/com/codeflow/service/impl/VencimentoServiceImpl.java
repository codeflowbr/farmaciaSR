...
public class VencimentoServiceImpl implements VencimentoService {
	...
	public void dataVerify() {
		...
		List<VendaEntity> listaVendas = vendaRepository.findAllByDataMensagemLessThanEqualAndMensagemEnviadaIsFalse(new Date());
